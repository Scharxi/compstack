  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.availableComponents}</div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">In Benutzung</CardTitle>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.inUseComponents}</div>
          <p className="text-xs text-muted-foreground">
            Zugewiesene Komponenten
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            Komponenten mit fälliger Wartung
          </p>
        </CardContent>
      </Card>
    </div>
